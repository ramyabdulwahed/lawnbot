...
{
  new (message_memory) main_controller_interfaces::msg::MotorData(_init);
}

void MotorData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<main_controller_interfaces::msg::MotorData *>(message_memory);
...
{
  return &::main_controller_interfaces::msg::rosidl_typesupport_introspection_cpp::MotorData_message_type_support_handle;
}
